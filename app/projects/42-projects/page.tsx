...
import { proj_42 } from "@/app/42_proj";
...
const FortyTwoProj = () => {
  return (
    <div className="w-full px-6 py-16 lg:px-24 justify-start">
      ...
      <p className="py-4 px-6 text-md italic">
        This table lists more notable projects completed in the 42 Core
        Curriculum.
        <br />
        For the full repository, click{" "}
        <a
          href="https://www.github.com/gka1m/42-core/"
          target="_blank"
          className="group inline-flex items-center gap-1 hover:text-cyan-400"
        >
          here
